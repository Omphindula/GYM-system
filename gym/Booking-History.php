...
<body>
	...
	<!-- Page top Section -->
	<	<section class="relative bg-cover bg-center py-32" style="background-image: url('https://media.istockphoto.com/id/1438034462/photo/latino-and-african-sport-woman-exercising-and-build-muscle-in-stadium-active-strong-beautiful.jpg?s=612x612&w=0&k=20&c=kFwCRkh8Q1v6uCoSTL7sQcsbk02zgSZJ1kDgnJ3DAZc=');">
		<div class="container">
			<div class="row">
				<div class="col-lg-7 m-auto text-white">
					<h2 style="text-align:center" style="color:#152228">Booking History</h2>
				</div>
			</div>
		</div>
	</section>
